...
{
    class Ashe// By RL244 Q Waiting For Remake. 리메이크 수치 확인용으로 일단 대기. 
    {
        ...
        public static void Load()
        {
            ...
            W.SetSkillshot(0.25f, 60f, 1500f, true, SkillshotType.SkillshotLine); // 투과 안되는 Cone이므로 충돌 판단을 쉽게 하기 위해 스킬타입 Line인 것처럼 설정. 실제 게임상 문제없음.
