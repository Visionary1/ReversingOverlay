...
namespace ALL_In_One.champions
{
    class Morgana// By RL244 
    {
        ...
        static float getEBuffDuration { get { var buff = AIO_Func.getBuffInstance(Player, "asheqattack"); return buff != null ? buff.EndTime - Game.ClockTime : 0; } }
        ...
        public static void Load()
        {
            ...
            R = new Spell(SpellSlot.R, 650f, TargetSelector.DamageType.Magical){Delay = 0.5f};
